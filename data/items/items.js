...
window.GUILD_SHOP_ITEMS = [
    ...
    { id: "kyudo_uniform", name: "静心の弓道着", price: 190, wearable: true,
      category: "set", layers: {
    ...
    */
    { id: "meteor_swordsman_fullset", name: "流星の剣士装備", price: 310, wearable: true,
      category: "fullset", equipmentType: "fullset", layers: {
          outer: "assets/characters/player/clothes/outer/cloudstrife_outerset.PNG"
      } },

    { id: "black_dog_costume", name: "黒い犬の着ぐるみ", price: 130, wearable: true,
      category: "fullset", equipmentType: "fullset", layers: {
